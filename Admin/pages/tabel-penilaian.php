        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Data Penilaian Penerima Raskin</h5>
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <?php
                                        $sql_penduduk = "SELECT * FROM tb_nilai_penduduk";
                                        $data_penduduk = $conn->query($sql_penduduk);
                                        $nomer = 0;
                                        while($row=$data_penduduk->fetch_array()){
                                            $NIK = $row['NIK'];
                                            $sql_nama      = mysqli_query($conn,"SELECT * from tb_penduduk where NIK ='$NIK'");
                                            $nama_penduduk     = mysqli_fetch_array($sql_nama);
                                        
                                        ?>
                                            
                                            <tr>
                                                <td><?php echo $row['NIK']; ?></td>
                                                <td><?php echo $nama_penduduk['Nama']; ?></td>
