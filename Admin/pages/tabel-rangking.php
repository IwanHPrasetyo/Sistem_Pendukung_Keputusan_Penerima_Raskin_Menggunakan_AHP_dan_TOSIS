        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Data Ranking Penerima Raskin</h5>
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <?php
$sql_ranking = "SELECT * FROM tb_ranking";
$data_ranking = $conn->query($sql_ranking);
$nomer = 0;

while ($row = $data_ranking->fetch_array()) {
    $NIK = $row['NIK'];
    $sql_penduduk = mysqli_query($conn, "SELECT * from tb_penduduk where NIK ='$NIK'");
