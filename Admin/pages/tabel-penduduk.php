        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Tabel Penduduk</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Tabel Penduduk</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                        <h5 class="card-header">Data Penduduk Kecamatan Kromengan <a href="form-penduduk.php" class="btn btn-rounded btn-light" style="margin-left:55%;">Tambah Siswa</a> </h5>
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <?php
                                            $sql_penduduk = "SELECT * FROM tb_penduduk";
                                            $data_penduduk = $conn->query($sql_penduduk);
                                            $nomer = 0;
                                            while ($row = $data_penduduk->fetch_array()) {

                                                ?>

                                            <tr>
                                                <td><?php $nomer = $nomer + 1;
                                                            echo $nomer;?></td>
                                                <td>
                                                ...
                                                <td>
                                                    <center>
                                                    <a href="form-edit-penduduk.php?id=<?php echo $row['NIK']; ?>" class="btn btn-rounded btn-info">Edit</a>
                                                    <a href="../../proses/hapus_penduduk.php?id=<?php echo $row['NIK']; ?>" class="btn btn-rounded btn-danger">Hapus</a>
                                                    </center>
                                                </td>
                                            </tr>
